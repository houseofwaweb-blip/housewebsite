...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      `frame-src 'self' ${OBF} https://challenges.cloudflare.com https://www.facebook.com https://www.instagram.com https://www.youtube-nocookie.com https://www.youtube.com`,
