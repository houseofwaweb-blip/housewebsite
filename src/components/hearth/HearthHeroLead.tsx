    ...
    <section className="max-w-[1360px] mx-auto my-12 px-[5vw]">
      ...
      >
        ...
        <div>
          ...
          <h1 className="font-hearth-serif font-medium leading-[1.04] tracking-[-0.01em] text-[clamp(42px,4.6vw,68px)] text-house-black mb-[18px] transition-colors duration-[var(--t-base)] ease-out group-hover:text-house-gold">
