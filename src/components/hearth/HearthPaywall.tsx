  ...
  return (
    <div className="my-14 -mx-4 md:-mx-12 lg:-mx-20">
      ...
      >
        ...
        {/* Prominent H mark */}
        <div className="flex items-center justify-center w-16 h-16 bg-house-gold text-white font-hearth-serif italic text-[32px] leading-none shadow-[0_4px_16px_rgba(184,148,62,0.25)] max-md:w-14 max-md:h-14 max-md:text-[26px]">
          H
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-8 mb-7 py-6 border-t border-b border-house-brown/12 max-md:grid-cols-1 max-md:gap-4">
            <div>
              <p className="font-hearth-sans text-[9px] tracking-[0.24em] uppercase text-house-gold mb-3">
                What you get
              </p>
              <ul className="list-none m-0 p-0">
                {[
                  ...
                  >
                    <span aria-hidden="true" className="text-house-gold font-bold flex-shrink-0">·</span>
                    {item}
                  </li>
                ))}
              </ul>
          ...
          <div className="flex items-center justify-between gap-5 flex-wrap max-md:flex-col max-md:items-start max-md:gap-4">
            ...
            <div className="flex items-center gap-5 flex-wrap max-md:w-full">
              ...
              <Link
                href="/howa/plans"
                className="font-hearth-sans text-[10px] tracking-[0.18em] uppercase text-house-brown no-underline border-b border-dotted border-house-brown pb-px transition-colors duration-[var(--t-base)] hover:text-house-gold hover:border-house-gold"
              >
                Compare plans
              </Link>
            </div>
