...
export function WaitlistForm({
  ...
  const selectCls = `w-full border px-3 py-2.5 text-[19px] outline-none transition-colors ${
    dark
  ...
  const labelCls = `block font-sans text-[18px] tracking-[0.04em] mb-1.5 ${dark ? "text-white/75" : "text-house-brown/70"}`;
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              {errors.tier?.message ? (
                <p className="font-sans text-[18px] text-red-700 mt-1">{errors.tier.message}</p>
              ) : null}
            </div>
            <div className="flex-1">
              <Input
