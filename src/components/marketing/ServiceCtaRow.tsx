      ...
      <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-3 text-center sm:flex-row sm:justify-center sm:gap-7">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
          <a
            ...
            className="inline-flex items-center bg-house-gold px-5 py-2.5 font-sans text-[10.5px] tracking-[0.18em] uppercase text-white no-underline transition-colors hover:bg-house-gold-dark"
          >
            Book through HoWA
          </a>
          <a
