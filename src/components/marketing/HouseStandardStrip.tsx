  ...
  return (
    <section className="bg-house-cream-dark/50 border-y border-house-brown/10 px-[5vw] py-[clamp(48px,5vw,76px)]">
      <div className="max-w-[920px] mx-auto text-center">
        <p className="font-sans text-[10px] tracking-[0.3em] uppercase text-house-gold mb-4">
          The quiet bar
        </p>
        ...
        <ul className="mt-8 flex flex-wrap justify-center gap-x-10 gap-y-3 list-none p-0 m-0">
          {POINTS.map((p) => (
            <li
              key={p}
              className="flex items-center gap-2.5 font-sans text-[12px] tracking-[0.06em] text-house-brown/70"
            >
