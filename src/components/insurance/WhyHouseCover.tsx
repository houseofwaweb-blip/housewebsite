  ...
  return (
    <section className="px-[5vw] py-14">
      <div className="mx-auto max-w-[1080px]">
        ...
        <h2 className="mt-3 max-w-[24ch] font-display text-[clamp(24px,3.4vw,40px)] leading-[1.1] text-house-black">
        ...
        <div className="mt-9 grid gap-x-10 gap-y-9 sm:grid-cols-2">
          {pillars.map((p) => (
            <div key={p.h} className="border-t border-[color:var(--ins-ink)]/25 pt-5">
              <h3 className="font-display text-[21px] leading-tight text-house-black">{p.h}</h3>
              <p className="mt-2.5 font-sans text-[16px] leading-[1.6] text-house-brown/85">{p.p}</p>
            </div>
          ))}
        </div>
