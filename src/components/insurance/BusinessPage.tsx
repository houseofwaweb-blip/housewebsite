    ...
    <div className="ins-business bg-house-cream text-house-brown">
      ...
      <section className="px-[5vw] pt-20 pb-12">
        <div className="mx-auto grid max-w-[1120px] items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            <p className="font-sans text-[12px] tracking-[0.28em] uppercase text-[color:var(--ins-ink)]">Insurance · {data.hero.eyebrow}</p>
            <h1 className="mt-4 font-display text-[clamp(32px,5vw,58px)] leading-[1.04] text-house-black">{data.hero.heading}</h1>
            <p className="mt-6 max-w-[54ch] font-sans text-[18px] leading-[1.62] text-house-stone">{data.hero.lede}</p>
            <div className="mt-8">
      ...
      <section className="border-t border-house-brown/10 px-[5vw] py-12">
        <div className="mx-auto grid max-w-[1120px] items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          ...
          <div className="max-w-[560px]">
            <h2 className="font-display text-[clamp(24px,3vw,36px)] leading-[1.12] text-house-black">{data.who.heading}</h2>
            {data.who.body.map((p, i) => (
              <p key={i} className="mt-5 font-sans text-[17px] leading-[1.7] text-house-brown/85">{p}</p>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-house-brown/10 px-[5vw] py-12" style={data.silentReview ? { background: "var(--color-house-cream-dark)" } : undefined}>
        <div className="mx-auto max-w-[880px]">
          <h2 className="mb-8 font-display text-[clamp(22px,2.8vw,34px)] leading-[1.12] text-house-black">{data.detail.title}</h2>
      ...
      <section className="border-t border-house-brown/10 px-[5vw] py-12">
        <div className="mx-auto max-w-[760px]">
          <h2 className="font-display text-[clamp(22px,2.8vw,34px)] leading-[1.12] text-house-black">{data.placed.heading}</h2>
      ...
      <section id="enquire" className="scroll-mt-20 border-t border-house-brown/10 px-[5vw] py-14" style={{ background: "var(--color-house-cream-dark)" }}>
        <div className="mx-auto max-w-[620px]">
          <p className="font-sans text-[12px] tracking-[0.28em] uppercase text-[color:var(--ins-ink)]">Request a review</p>
          <h2 className="mt-3 font-display text-[clamp(24px,3vw,38px)] leading-[1.1] text-house-black">A free look at what you already hold.</h2>
