    ...
    >
      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-house-cream-dark mb-4">
        ...
        {product.houseApproved ? (
          <span className="absolute top-3 left-3 z-20 font-sans text-[12px] tracking-[0.22em] uppercase text-house-gold-dark bg-white/90 px-2.5 py-1 border border-house-gold/30">
            House Approved
          </span>
        ) : null}
