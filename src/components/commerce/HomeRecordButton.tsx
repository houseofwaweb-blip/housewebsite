...
export function HomeRecordButton({
  ...
  return (
    <button
      ...
      className={
        className ||
        "inline-flex w-full items-center justify-center gap-2 border border-house-gold-dark bg-house-gold-ink px-6 py-4 font-sans text-[14px] tracking-[0.18em] uppercase text-house-brown transition-[filter,transform] hover:brightness-110 cursor-pointer"
      }
    >
