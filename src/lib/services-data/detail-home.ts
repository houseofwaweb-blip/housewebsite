...
export const HOME_DETAIL: Record<string, RequestableDetail> = {
  ...
  plumbing: {
    ...
    practical: {
      ...
      excluded: [
        ...
        "Drain jetting, CCTV drain inspections and work on the shared or public sewer",
  ...
  "heating-boiler": {
    ...
    included: [
      ...
      "Replacement boilers and full system upgrades, quoted after a site visit",
    ],
    how: [
  ...
  "damp-proofing": {
    ...
    included: [
      "An inspection of the affected walls with moisture readings, taken internally and externally",
    ...
    how: [
      ...
      "An inspection is arranged, because we will not quote for treatment we have not diagnosed",
    ...
    faq: [
      ...
      {
        q: "How is this priced?",
        a: "The inspection is charged as its own visit, and any remedial work is quoted from the findings. You are free to take the report and do nothing, or to use it to get other prices.",
      },
      {
    ...
    practical: {
      duration: "One to two hours for the inspection, and several days for remedial works",
      materials: "Meters and inspection equipment on the visit, remedial materials quoted after",
      access: "Access to both faces of the wall where possible, plus any cellar, void or loft",
      parking: "A space near the property for the inspection and works visits",
      excluded: [
