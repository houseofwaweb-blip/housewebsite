...
export const SERVICES: Record<ServiceSlug, Service> = {
  gardening: {
    ...
    sections: {
      ...
      how: [
        ...
        "We arrive when arranged, and confirm the visit once it is done",
      ],
    },
    recurring: true,
  ...
  "window-cleaning": {
    ...
    sections: {
      ...
      how: [
        ...
        "Book a one-off, or a monthly / bi-monthly rhythm",
        "A reminder the day before, and confirmation once the visit is done",
      ],
    },
    recurring: true,
    availableAreas: ["SW", "W", "KT", "W4", "W6", "TW"],
  ...
  cleaning: {
    ...
    faq: [
      { q: "Can I choose my own products?", a: "Yes. Note your preferences in HoWA and the team will follow them. We default to House-standard, fragrance-free ranges." },
  ...
  handyman: {
    ...
    sections: {
      ...
      how: [
        ...
        "The work is photographed so you have a clear before and after",
      ],
    },
    recurring: false,
  ...
  energy: {
    ...
    sections: {
      ...
      how: [
        ...
        "Certification and paperwork sent straight to you",
      ],
    },
    recurring: false,
    availableAreas: ["SW", "W", "KT", "SE", "BR", "DA", "TN"],
    packages: [
      ...
      },
      {
        ...
        inclusions: [
          ...
          "Completion certificate sent straight to you",
        ],
        cta: "quoteEntry",
      },
      {
  ...
  "pet-care": {
    slug: "pet-care",
    name: "Pet Care",
    lede: "Trusted, insured dog walking and pet sitting by experienced handlers. GPS-tracked walks, photo updates, and visit notes sent to you after every visit.",
