 ...
 * volume, hourly, or after a site visit) rather than publishing a number the
 * House would then have to walk back.
 *
...
export const MOVING_DETAIL: Record<string, RequestableDetail> = {
  ...
  removals: {
    ...
    how: [
      ...
      "We assess by video or in person, then quote on volume, distance and access",
  ...
  "ev-charger": {
    ...
    included: [
      "An assessment of the consumer unit, incoming supply and earthing arrangement",
    ...
    how: [
      ...
      "We arrange an assessment, by photographs or on site, and confirm what your supply allows",
    ...
    faq: [
      {
        ...
        a: "Because the cost turns on the cable run, the state of the consumer unit and the earthing arrangement, none of which we can see from a postcode. A site assessment turns that into a fixed price, and we will tell you the assessment cost up front.",
      },
      {
    ...
    practical: {
      ...
      materials: "The charge point, cable, isolator and any protective devices are quoted after the assessment.",
  ...
  "solar-battery": {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Older or poorly maintained roofs sometimes need repair before panels go on, and shading from trees or a neighbouring building can cut output badly. Both are found at the assessment, and we would rather lose the job than fit a system that underperforms.",
      },
    ],
    practical: {
      duration: "A typical domestic install is two to three days on site, after an assessment and a design period.",
      materials: "Panels, inverter, battery, mounting and protective devices are specified and quoted after the assessment.",
  ...
  "smart-home": {
    ...
    included: [
      "An assessment of the property, the incoming broadband and where the signal currently fails",
    ...
    how: [
      ...
      "We assess the building, the broadband and the dead spots, then propose a design",
    ...
    faq: [
      {
        ...
        a: "In a small flat that is often the right answer and we will say so. In a period house with solid walls, a basement or a garden room, mesh over Wi-Fi struggles and a wired backbone is what fixes it properly. The assessment tells us which house you have.",
      },
      {
    ...
    practical: {
      ...
      materials: "Access points, switches, cable, containment and control equipment are quoted after the assessment.",
  ...
  "security-alarms": {
    ...
    how: [
      ...
      "We assess the property and propose a design, with the equipment and monitoring options priced",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "False alarms from badly placed sensors, cameras pointed at a bright sky, and batteries nobody replaced. The assessment deals with the first two. The third is why we recommend a service visit, and we will quote it rather than assume it.",
      },
    ],
    practical: {
      duration: "A domestic alarm or camera install is usually one to two days after the assessment.",
