...
export const HOUSEHOLD: HouseholdMember[] = [
  ...
  { id: "gardener", publicName: "The Gardener", promise: "Show me the garden and I will help you see what the season asks.", group: "need", toolStatus: "beta", serviceStatus: "live", route: "/household/gardener", image: "/howa/household/gardener.webp", action: "Scan the garden" },
  { id: "handyman", publicName: "The Handyman", promise: "Photograph the fault and understand what it may be, how urgent it feels and what to ask next.", group: "need", toolStatus: "beta", serviceStatus: "in_build", route: "/household/handyman", image: "/howa/household/handyman.webp", action: "Photograph a fault" },
  { id: "designer", publicName: "The Designer", promise: "Turn one room or garden into a direction, a proper brief and the right studio route.", group: "need", toolStatus: "beta", serviceStatus: "live", route: "/household/designer", image: "/howa/household/designer.webp", action: "Begin a design project" },
  { id: "surveyor", publicName: "The Surveyor", promise: "Read a crack, damp concern, report or quote in plain language.", group: "need", toolStatus: "beta", serviceStatus: "future", route: "/household/surveyor", image: "/howa/household/surveyor.webp", action: "Decode a concern" },
  { id: "archivist", publicName: "The Archivist", promise: "Turn paperwork into dates, costs, reminders and proof.", group: "need", toolStatus: "beta", serviceStatus: "future", route: "/household/archivist", image: "/howa/household/archivist.webp", action: "Send one document" },
  { id: "storekeeper", publicName: "The Storekeeper", promise: "Keep considered goods organised by the rooms and needs of the home.", group: "need", toolStatus: "live", serviceStatus: "live", route: "/shop", image: "/howa/household/storekeeper.webp", action: "Enter The Stores" },
