 ...
 *
 * Default (everyone): allow the site, hide machine/admin/fallback paths, and
 * hide the crawl traps that inflate edge requests when several bots crawl at
 * once (2026-09 usage anomaly: /shop filtered/paginated URLs + old WordPress
 * probe paths). The canonical /shop and /shop/[handle] pages stay indexable.
 *
