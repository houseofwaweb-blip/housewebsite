...
function ScoreCard() {
  return (
    <Card>
      <p className="text-[11px] uppercase tracking-[0.18em] text-[#1a241d] flex items-center gap-1.5">
        <ShieldGlyph /> HoWA Score
      </p>
      <p className="text-[13px] text-[#3a352c]/75 mt-1 mb-3.5">In order, with gaps</p>
    ...
    <Card>
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-[13px] text-[#3a352c]/75 mt-1">Updated today</p>
          <p className="text-[13px] text-[#3a352c]/75">08:42</p>
          <a href="#demo" className="inline-flex items-center gap-1 text-[13px] text-[#8a6f3f] mt-3 hover:text-[#6f5832] transition-colors">View record →</a>
        </div>
...
function ActionCard() {
  ...
  return (
    <Card>
      <p className="text-[11px] uppercase tracking-[0.18em] text-[#1a241d] flex items-center gap-1.5 mb-2">
        <ClipboardGlyph /> What matters first
      </p>
      <p className="text-[13.5px] text-[#1a241d]">3 things need attention</p>
      <p className="text-[12.5px] text-[#3a352c]/70 mb-3">HoWA tells you what matters first</p>
      <ul className="space-y-1.5 mb-3">
        {items.map((t) => (
          <li key={t} className="flex items-center gap-2 text-[13px] text-[#3a352c]">
            <CheckGlyph /> {t}
          </li>
        ))}
      </ul>
      <a href="#tiers" className="inline-flex items-center gap-1 text-[13px] text-[#8a6f3f] hover:text-[#6f5832] transition-colors">View plan →</a>
    </Card>
  );
}
