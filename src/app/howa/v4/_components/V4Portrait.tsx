    ...
    <section id="portrait" className="scroll-mt-20 bg-[#fbfaf5] py-16 lg:py-24">
      <div className="mx-auto max-w-[1100px] px-6 sm:px-10">
        <div className="mx-auto max-w-[680px] text-center">
          <p className="smallcaps mb-3 text-[14px] tracking-[0.2em] text-[color:var(--color-gold-deep)]">The first minute</p>
          ...
          <p className="mt-4 flex flex-wrap items-center justify-center gap-x-5 gap-y-1 text-[14px] text-[color:var(--color-ink-soft)]/70">
        ...
        <div className="mt-10 grid items-start gap-5 lg:grid-cols-[1.45fr_1fr]">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            {facts.map((f) => (
              <div key={f.k} className="rounded-xl border border-[color:var(--color-gold)]/20 bg-white p-5">
                ...
                <p className="mt-1.5 text-[14px] leading-snug text-[color:var(--color-ink-soft)]/80">{f.note}</p>
              </div>
            ))}
            <div className="flex flex-col justify-center rounded-xl border border-[color:var(--color-gold)]/20 bg-white p-5">
              ...
              <p className="mt-2 text-center text-[14px] text-[color:var(--color-ink-soft)]/60">Free. The record begins with your address.</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-2xl bg-[#1d2a40] p-6 text-[#f3ede0]">
              ...
              <p className="mt-4 text-[14px] leading-[1.5] text-[#f3ede0]/75">
