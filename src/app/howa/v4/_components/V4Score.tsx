      ...
      <div className="mx-auto max-w-[1180px] px-6 py-16 sm:px-10 lg:py-24">
        <div className="grid items-center gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-14">
          <div>
            ...
            <p className="mt-4 max-w-[440px] text-[16.5px] leading-[1.55] text-[#f3ede0]/80">
            ...
            <ul className="mt-6 space-y-2 text-[14.5px] text-[#f3ede0]/75">
        ...
        <p className="mt-8 max-w-[780px] text-[14.5px] leading-[1.6] text-[#f3ede0]/70">
