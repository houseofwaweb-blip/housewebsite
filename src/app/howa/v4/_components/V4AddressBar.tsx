    ...
    <div className="flex max-w-[440px] flex-col gap-2.5 sm:flex-row">
      <span className="flex flex-1 items-center gap-2 rounded-md border border-[color:var(--color-gold)]/35 bg-white px-4 py-3 shadow-[0_10px_30px_-18px_rgba(40,30,10,0.4)]">
        ...
        <input
          ...
          className="w-full bg-transparent text-[19px] text-[color:var(--color-ink)] placeholder:text-[color:var(--color-ink-soft)]/45 focus:outline-none"
        />
      </span>
      <button onClick={go} className="inline-flex items-center justify-center gap-2 rounded-md bg-[color:var(--color-howa-green)] px-6 py-3 text-[19px] text-white transition-colors hover:bg-[color:var(--color-howa-green-deep)]">
