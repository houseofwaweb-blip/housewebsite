    ...
    <section className="scroll-mt-20 bg-[#fbfaf5] py-16 lg:py-24 border-t border-[color:var(--color-ink)]/8">
      <div className="mx-auto max-w-[1180px] px-6 sm:px-10">
        <div className="max-w-[760px]">
          <p className="smallcaps mb-3 text-[18px] tracking-[0.2em] text-[color:var(--color-gold-deep)]">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          {[
            ...
            >
              <p className="smallcaps mb-4 text-[14px] tracking-[0.18em] text-[color:var(--color-gold-deep)]">
                {col.title}
              </p>
              <ul className="space-y-3">
                {col.items.map((it) => (
                  <li
                    key={it}
                    className="flex gap-3 text-[19px] leading-[1.5] text-[color:var(--color-ink-soft)]"
                  >
        ...
        <p className="mt-9 max-w-[820px] font-italic-display text-[clamp(21px,1.9vw,27px)] leading-[1.35] text-[color:var(--color-gold-deep)]">
