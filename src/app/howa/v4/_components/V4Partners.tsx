  ...
  return (
    <section id="partners" className="scroll-mt-20 bg-[#fbfaf5] py-14 border-t border-[color:var(--color-ink)]/8">
      <div className="mx-auto max-w-[860px] px-6 text-center sm:px-10">
        ...
        <p className="smallcaps mb-3 text-[18px] tracking-[0.2em] text-[color:var(--color-gold-deep)]">Partners</p>
        <p className="font-display text-[clamp(22px,2vw,29px)] leading-[1.3] text-[color:var(--color-ink)]">
          Partners appear where they help the home record.
        </p>
        <p className="mt-3 smallcaps text-[14px] tracking-[0.16em] text-[color:var(--color-gold-deep)]/75">
          Energy · Insurance readiness · Conveyancing · Home goods
        </p>
        <p className="mt-4 text-[18px] text-[color:var(--color-ink-soft)]/60">
          With your consent, and only where they help the home, never a directory or a discounts club.
        </p>
        <a href="mailto:sales@willowalexander.co.uk?subject=HoWA partner enquiry" className="mt-4 inline-flex items-center gap-1.5 text-[18px] text-[color:var(--color-gold-deep)] underline underline-offset-2">
