...
const TIERS: {
...
}[] = [
  {
    ...
    visual: { kind: "illustration", src: "/home-v4/assistant-dollhouse.png", alt: "Doll house — Assistant tier" },
    features: [
  ...
  },
  {
    ...
    visual: { kind: "phone", src: "/home-v4/steward-phone-housekeeper.png", alt: "Today's Plan — Housekeeper phone" },
    features: [
  ...
  },
  {
    ...
    visual: { kind: "phone", src: "/home-v4/steward-phone-steward.png", alt: "House Health 91% Optimal — Steward phone" },
    features: [
