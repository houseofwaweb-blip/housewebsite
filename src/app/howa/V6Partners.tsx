      ...
      <section id="fulfilment" className="bg-[#efe7d5] border-t border-[color:var(--color-gold)]/25 scroll-mt-20">
        <div className="max-w-[1240px] mx-auto px-6 sm:px-10 py-16 lg:py-20 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          <div className="lg:col-span-7">
            <p className="smallcaps text-[14px] tracking-[0.2em] text-[color:var(--color-gold-deep)] mb-5">The House at work</p>
            <h2 className="font-italic-display text-[clamp(31px,3vw,47px)] leading-[1.1] text-[color:var(--color-ink)]">
              When the work needs doing, the House steps in.
            </h2>
            <p className="mt-4 text-[clamp(20px,1.7vw,24px)] leading-[1.5] text-[color:var(--color-ink-soft)] max-w-[560px]">
            ...
            <div className="mt-9 grid grid-cols-2 sm:grid-cols-3 gap-3 max-w-[520px]">
              {WA_BRANDS.map((b) => (
                <div key={b.name} className="rounded-md px-3.5 py-4 text-[#f3ede0]" style={{ background: b.color }}>
                  <p className="smallcaps text-[10.5px] tracking-[0.14em] text-[#f3ede0]/70">Willow Alexander</p>
                  <p className="font-display text-[19px] leading-tight mt-0.5">{b.name}</p>
                </div>
              ))}
            </div>
            <p className="mt-6 text-[19px] leading-[1.5] text-[color:var(--color-ink-soft)]/85 max-w-[520px]">
      ...
      <section id="partners" className="bg-[#f4f1e9] scroll-mt-20">
        <div className="max-w-[1240px] mx-auto px-6 sm:px-10 py-16 lg:py-20">
          <div className="text-center max-w-[660px] mx-auto">
            ...
            <p className="smallcaps text-[14px] tracking-[0.18em] text-[color:var(--color-gold-deep)] mb-4">Partnerships &middot; by the House of Willow Alexander</p>
            <h2 className="font-italic-display text-[clamp(31px,3vw,47px)] leading-[1.1] text-[color:var(--color-ink)]">
            ...
            <p className="mt-7 text-[20px] leading-[1.55] text-[color:var(--color-ink-soft)]">
              Hand-picked British institutions across property, the home and beyond. First names announced soon.
            </p>
            <p className="mt-7 smallcaps text-[14px] tracking-[0.16em] text-[color:var(--color-gold-deep)]/70 leading-[1.9]">
              {CIRCLE.join("  ·  ")}
            </p>
          </div>
        </div>
      ...
      <section id="founding-partner" className="text-[#f3ede0] scroll-mt-20" style={{ background: "#1d2a40" }}>
        <div className="max-w-[1240px] mx-auto px-6 sm:px-10 py-14 lg:py-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
          <div className="max-w-[680px]">
            <p className="smallcaps text-[14px] tracking-[0.18em] text-[#f3ede0]/55 mb-4 flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#c5a960]" /> Founding partners
            </p>
            <h2 className="font-display text-[clamp(29px,2.6vw,41px)] leading-[1.1] text-[#f3ede0]">
              Building something for the British home?
            </h2>
            <p className="mt-4 text-[18.5px] leading-[1.55] text-[#f3ede0]/80 max-w-[600px]">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center gap-2 rounded-md bg-[#c5a960] px-7 py-3.5 font-mono text-[18px] tracking-[0.02em] text-[#1d2a40] hover:bg-[#d4ba78] transition-colors"
          >
