      ...
      <div className="mx-auto max-w-[1240px] px-6 sm:px-10">
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <div className="min-w-0 lg:pt-1">
            <p className="smallcaps mb-3 text-[12px] tracking-[0.2em] text-[color:var(--color-gold-deep)]">Starts the moment you join</p>
            ...
            <div className="mt-7 flex max-w-[460px] items-center gap-2 rounded-full border border-[color:var(--color-gold)]/35 bg-white px-4 py-2.5 shadow-[0_10px_30px_-18px_rgba(40,30,10,0.4)]">
              ...
              <span className="rounded-full bg-[color:var(--color-howa-green)] px-4 py-1.5 text-[13px] text-white">Reveal</span>
            </div>
