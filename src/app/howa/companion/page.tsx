...
const EXAMPLES = [
  ...
  { issue: "Cracking render on the side wall", answer: "Hairline cracking in render is common on cement-rendered masonry. Check for hollow patches by tapping. If solid, a flexible exterior filler will hold.", next: "Tapped the wall \u2014 solid. Filled with exterior filler. Noted for the Home Protection Review next quarter." },
