    ...
    <section className="relative text-[#f3ede0] overflow-hidden" style={{ background: "#27384c" }}>
      <div className="max-w-[1320px] mx-auto px-6 sm:px-10 py-14 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-4">
          <p className="smallcaps text-[14px] tracking-[0.18em] text-[#f3ede0]/60 mb-3 flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-[#c5a960]" /> Stewardship
          </p>
          <h2 className="font-display text-[clamp(32px,2.8vw,45px)] leading-[1.05] text-[#c5a960]">
            Built to be handed on, not handed over.
          </h2>
          <p className="mt-4 text-[18.5px] leading-[1.55] text-[#f3ede0]/85 max-w-[340px]">
            HoWA Steward protects what matters now and prepares for the future with clarity, care and confidence.
          </p>
          <a href="#tier-steward" className="mt-6 inline-flex items-center gap-2 rounded-md border border-[#f3ede0]/45 px-6 py-3 text-[19px] text-[#f3ede0] hover:bg-[#f3ede0]/10 transition-colors">
        ...
        <div className="lg:col-span-3">
          ...
          <p className={`${hand.className} mt-6 text-[24px] text-[#c5a960]`}>A legacy well kept.</p>
        </div>
      </div>
    </section>
  );
