      ...
      <section className="px-[5vw] pt-[12vh] pb-14">
        <div className="max-w-[720px] mx-auto">
          ...
          <p className="font-sans text-[15px] leading-[1.6] text-house-brown/55 mt-6 max-w-[64ch]">
            ...
            approved partners. Online bookings and your account are handled
            through HoWA, a separate service operated under its own terms.
            Information you add there is held within that service, not by
