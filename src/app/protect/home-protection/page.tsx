...
export default function HomeProtectionPage() {
  return (
    <div className={s.page}>
        ...
        <div className={s.heroCopy}>
          <div className={s.heroCopyInner}>
            ...
            <h1 className={s.heroTitle}>
              Know the home <em>before the home needs you.</em>
            </h1>
            <p className={s.heroLede}>
              A one-day in-person review by House-vetted specialists. A
              condition survey, an evidence pack, and insurance-ready
              documentation — filed to your HoWA record and ready for whatever
              comes next.
            </p>
      ...
      <section className={s.statsStrip}>
        <div className={s.statsLede}>
          <p className={s.statsLedeLine1}>One day on-site. One record. Years of clarity.</p>
          <p className={s.statsLedeLine2}>The first practical act of Home Protection.</p>
        </div>
        {STAT_COLS.map((stat) => (
      ...
      <section className={s.covers}>
        <header className={s.coversHead}>
          <p className={s.coversEy}>What the review covers</p>
          <h2 className={s.coversTitle}>
            Everything the home quietly needs, <em>surfaced in one day.</em>
          </h2>
        </header>
      ...
      <section className={s.steps}>
        <header className={s.stepsHead}>
          ...
          <h2 className={s.stepsTitle}>
            Four steps to a <em>calmer home.</em>
          </h2>
        </header>
      ...
      <section id="register" className={s.register}>
        <div className={s.registerImage}>
          <Image
            ...
            alt="Still life of stewardship — brass padlock, smoke detector, key, and chain on a wooden cabinet"
            fill
        ...
        <div className={s.registerCopy}>
          <p className={s.registerEy}>Register interest</p>
          <h2 className={s.registerTitle}>
            Opening in <em>late 2026.</em>
          </h2>
          <p className={s.registerLede}>
            Leave your email and we'll write when Home Protection opens. HoWA+
            members go to the front of the list.
          </p>
          <WaitlistMini
      ...
      <section className={s.crossSell}>
        <article className={s.crossCard}>
          ...
          <h3 className={s.crossTitle}>House Approved Insurance</h3>
          ...
          <Link href="/protect/insurance" className={s.crossLink}>
      ...
      <section className={s.closing}>
        <p className={s.closingStatement}>
          <em>Prevention is quieter than repair.</em> That's the point.
        </p>
      </section>
    </div>
  );
