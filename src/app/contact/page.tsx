    ...
    <div className={s.page}>
      ...
      <section className="border-t border-house-line px-[5vw] py-[clamp(28px,3.5vw,48px)]">
        <div className="mx-auto max-w-[1180px]">
          <p className="mb-4 font-sans text-[13px] tracking-[0.22em] uppercase text-house-gold-dark">
            Book a service
          </p>
          <PostcodeBooking
      ...
      <section className="border-t border-house-line bg-house-cream-light px-[5vw] py-[clamp(32px,4vw,56px)]">
        <div className="mx-auto grid max-w-[1180px] gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <p className="font-sans text-[13px] tracking-[0.22em] uppercase text-house-gold-dark">Call the House</p>
            ...
            <p className="mt-1 font-sans text-[17px] text-house-brown/70">Freephone, from a UK line.</p>
          </div>
          <div>
            <p className="font-sans text-[13px] tracking-[0.22em] uppercase text-house-gold-dark">Email</p>
            <a href="mailto:sales@willowalexander.co.uk" className="mt-2 block font-display text-[clamp(1.05rem,1.4vw,1.3rem)] text-house-ink no-underline hover:text-house-brown">
              {/* Break only at the @ — each part stays whole so the address never
                  splits mid-word (e.g. "...co.u / k"). */}
              <span className="whitespace-nowrap">sales@</span>
              <wbr />
              <span className="whitespace-nowrap">willowalexander.co.uk</span>
            </a>
            <p className="mt-1 font-sans text-[17px] text-house-brown/70">We reply within one working day.</p>
          </div>
          <div>
            <p className="font-sans text-[13px] tracking-[0.22em] uppercase text-house-gold-dark">Opening hours</p>
            <p className="mt-2 font-sans text-[18px] leading-relaxed text-house-brown/85">
          ...
          <div>
            <p className="font-sans text-[13px] tracking-[0.22em] uppercase text-house-gold-dark">Something urgent?</p>
            <p className="mt-2 font-sans text-[18px] leading-relaxed text-house-brown/85">
