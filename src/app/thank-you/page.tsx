  ...
  return (
    <div className="relative overflow-hidden bg-house-cream text-house-brown">
      ...
      <section className="relative z-10 mx-auto flex min-h-[70vh] max-w-[760px] flex-col items-center justify-center px-[6vw] py-[clamp(80px,10vw,160px)] text-center">
        <p className="mb-5 font-sans text-[14px] uppercase tracking-[0.32em] text-house-gold-ink">
          The House of Willow Alexander
        </p>
        <h1 className="font-display text-[clamp(51px,7vw,91px)] leading-[1.04] tracking-[-0.01em] text-house-brown">
          Thank you.
        </h1>
        <p className="mt-6 max-w-[46ch] font-sans text-[20px] leading-[1.75] text-house-brown/75">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/the-hearth"
            className="inline-flex items-center justify-center border border-house-brown/25 px-8 py-4 font-sans text-[14px] uppercase tracking-[0.18em] text-house-brown no-underline transition-colors hover:border-house-brown"
          >
            Read the Hearth
          </Link>
        </div>

        <p className="mt-10 font-sans text-[16px] text-house-brown/50">
