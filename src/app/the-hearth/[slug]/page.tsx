        ...
        {prev || next ? (
          ...
          >
            {prev ? (
              ...
              >
                <span aria-hidden className="font-hearth-sans text-[14px] text-house-stone transition-colors group-hover:text-house-gold-dark">←</span>
