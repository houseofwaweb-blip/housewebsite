...
const PLANS = [
  {
    name: "Planting Plans",
    tagline: "A considered planting direction for your space.",
    price: "from £495",
    handle: "planting-plans",
    inclusions: [
      "An annotated planting layout: structure, spacing and flow",
      "A plant palette for form, texture and seasonal interest",
      "Guidance on height, density and long-term growth",
      "Notes on character, maintenance level and rhythm",
    ],
  ...
  },
  {
    ...
    inclusions: [
      "A guiding design concept and narrative",
      "An indicative layout of zones and flow",
      "A materials and finishes palette",
      "Planting inspiration and conceptual lighting intent",
    ],
  ...
  {
    name: "2D & 3D Plans",
    tagline: "An illustrative visual plan of your garden.",
    price: "from £2,950",
    handle: "2d-3d-plans",
    inclusions: [
      "An illustrative plan: layout, materials, planting and atmosphere",
      "High-resolution visuals",
      "A consultation call with your Garden Designer, booked after purchase",
    ],
...
const SPECIALIST = [
  {
    ...
    body: "A lighting concept and evening mood strategy: an annotated layout of zones, focal points and hierarchy, with guidance on fixture types, positioning and warmth.",
