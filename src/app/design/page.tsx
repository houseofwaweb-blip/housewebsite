    ...
    <div className={s.page}>
      ...
      <section className={s.disciplines}>
        <header className={s.disciplinesHead}>
          ...
          <p style={{ fontFamily: "var(--font-sans)", fontSize: 18, lineHeight: 1.7, color: "rgba(48,35,28,0.72)", margin: "18px auto 0", maxWidth: "64ch" }}>
            {cms(
              disciplines,
              "body",
      ...
      <section className="px-[5vw] py-[clamp(56px,8vw,112px)] bg-house-cream-dark">
        <div className="mx-auto max-w-[1100px]">
          <p className="text-center" style={{ fontFamily: "var(--font-sans)", fontSize: 12, letterSpacing: "0.28em", textTransform: "uppercase", color: "var(--color-house-gold-ink)", margin: "0 0 14px", fontWeight: 500 }}>
          ...
          <ol className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 lg:gap-4 list-none p-0 m-0">
            {[
              ...
              <li key={step.n} className="text-center sm:text-left">
                <span style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontSize: 30, color: "var(--color-house-gold-ink)", display: "block", marginBottom: 8 }}>{step.n}</span>
                <p style={{ fontFamily: "var(--font-sans)", fontSize: 14, letterSpacing: "0.16em", textTransform: "uppercase", color: "var(--color-house-brown)", margin: "0 0 8px", fontWeight: 600 }}>{step.t}</p>
                <p style={{ fontFamily: "var(--font-sans)", fontSize: 15.5, lineHeight: 1.55, color: "rgba(48,35,28,0.7)", margin: 0 }}>{step.d}</p>
              </li>
            ))}
          </ol>
          <div style={{ marginTop: "clamp(36px,5vw,64px)", padding: "clamp(24px,3vw,40px)", background: "var(--color-house-forest)" }}>
            <p style={{ fontFamily: "var(--font-sans)", fontSize: 12, letterSpacing: "0.28em", textTransform: "uppercase", color: "var(--color-house-gold-light)", margin: "0 0 12px", fontWeight: 500 }}>
              The Design Record
            </p>
