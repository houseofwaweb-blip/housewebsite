    ...
    <div className="bg-house-cream text-house-brown">
      ...
      <section className="px-[5vw] pt-20 pb-16 max-w-[1100px] mx-auto">
        ...
        <p className="font-sans text-[19px] leading-[1.65] text-house-brown/80 mt-8 max-w-[58ch]">
          ...
          Household is how HoWA becomes easy to use. You ask one voice, HoWA, and
          the right household duty works behind it. The result returns to the same
          Home Record.
        </p>
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {FREE_DOORS.map((d) => (
              <div
                key={d.role}
                className="bg-house-cream border border-house-brown/12 p-6 flex flex-col"
              >
                <div
                  aria-hidden="true"
                  className="w-9 h-9 mb-4 border border-house-gold-ink/40 rotate-45"
                />
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {PAID_DEPTHS.map((d) => (
            <Link
              key={d.role}
              href={d.href}
              className="group block bg-house-cream-dark border border-house-brown/12 p-8 no-underline transition-colors hover:border-house-gold-ink/40"
            >
