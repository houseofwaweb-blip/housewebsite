  ...
  return (
    <article className="bg-house-cream text-house-brown">
      ...
      <section className="max-w-[1200px] mx-auto px-[5vw] pb-16 grid grid-cols-1 md:grid-cols-[1fr_380px] gap-12 items-start">
          ...
          {lines.map((line) => (
            <div key={line.id} className="py-5 border-t border-house-brown/8 grid grid-cols-[88px_1fr_auto] gap-4 items-start">
              ...
              <div>
                ...
                <p className="font-sans text-[18px] text-house-stone">
                  Quantity {line.quantity}
                </p>
              </div>
              <span className="font-display font-medium text-[20px] text-right">
                {line.price}
              </span>
            </div>
          ))}
        ...
        <div className="md:sticky md:top-[100px]">
          <div className="bg-house-white border border-house-brown/8 p-7">
            <h3 className="font-display font-medium text-[21px] mb-4">Order summary</h3>
            ...
            <p className="font-sans text-[14px] text-house-stone mt-2 mb-6 leading-[1.6]">
            ...
            {buyable ? (
              <button
                ...
                className="block w-full py-4 font-sans text-[18px] tracking-[0.18em] uppercase text-white bg-house-gold border border-house-gold text-center transition-colors duration-[var(--t-base)] ease-out hover:bg-house-gold-light hover:border-house-gold-light disabled:opacity-60 disabled:cursor-wait cursor-pointer"
              >
            ...
            <p className="flex items-center justify-center gap-2 mt-4 font-sans text-[14px] text-house-stone">
            ...
            <Link
              href="/shop/basket"
              className="block text-center mt-4 font-sans text-[14px] tracking-[0.14em] uppercase text-house-stone no-underline hover:text-house-brown transition-colors duration-[var(--t-base)]"
            >
              Return to basket
            </Link>
          </div>
      ...
      {redirecting ? (
        ...
        >
          <span className="font-display italic text-[clamp(27px,3vw,37px)] text-house-brown animate-pulse">
            Taking you to secure checkout…
          </span>
          <span className="mt-3 font-sans text-[14px] tracking-[0.18em] uppercase text-house-stone">
            One moment
          </span>
        </div>
      ) : null}
