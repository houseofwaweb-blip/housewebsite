      ...
      <section className="max-w-[1200px] mx-auto px-[5vw] pb-16 grid grid-cols-1 md:grid-cols-[1fr_360px] gap-12 items-start">
              ...
              <div className="grid grid-cols-[100px_1fr_auto] max-md:grid-cols-[80px_1fr] gap-4 items-start">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="mt-2.5 font-sans text-[12px] tracking-[0.14em] uppercase text-house-stone bg-transparent border-0 cursor-pointer hover:text-house-brown transition-colors duration-[var(--t-base)]"
                  >
                    Remove
                  </button>
                </div>
        ...
        <div className="md:sticky md:top-[80px]">
          <div className="bg-house-white border border-house-brown/8 p-7">
            ...
            <p className="font-sans text-[12px] text-house-stone mt-2 mb-5">
            ...
            <Link
              href="/shop"
              className="block text-center mt-3 font-sans text-[12px] tracking-[0.14em] uppercase text-house-stone no-underline hover:text-house-brown transition-colors duration-[var(--t-base)]"
            >
              Continue browsing
            </Link>
          </div>
